...
function compileC(filePath, options) {
    return __awaiter(this, void 0, void 0, function () {
        var compileTimeout, executableExt, cPath, executableName, executablePath, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, execute_command_1.execute('gcc', [filePath, '-o', executablePath], { timeout: compileTimeout })];
                case 1:
                    res = _a.sent();
                    if (res.exitCode !== 0) {
